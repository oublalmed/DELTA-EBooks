...
const EmailCapture: React.FC<EmailCaptureProps> = ({ variant = 'card', onSubscribe }) => {
    ...
    return (
      <div className={`${variant === 'banner' ? 'py-4' : 'p-8'} text-center`}>
        <div className="flex items-center justify-center gap-3">
          ...
          <p className="text-emerald-600 font-medium text-sm">Welcome aboard! Check your inbox for new chapter drops.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-stone-800 rounded-2xl p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div className="flex-1 text-center sm:text-left">
            <h3 className="text-white font-display font-medium text-lg mb-1">Get New Chapter Drops</h3>
  ...
  return (
    <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-3xl p-8 sm:p-10 text-center shadow-2xl">
      ...
      <h3 className="text-white font-display text-2xl font-medium mb-2">Stay in the Loop</h3>
      <p className="text-stone-400 text-sm mb-1">Get new chapter drops and reading prompts.</p>
