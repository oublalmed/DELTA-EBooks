      ...
      <main className="max-w-3xl mx-auto px-6 py-16 sm:py-20">
        ...
        <header className="mb-16 sm:mb-20 text-center animate-fadeIn">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-8 h-px bg-themed-muted" />
        ...
        <div className={`mb-20 sm:mb-28 ${isPartial ? 'relative' : ''}`}>
          ...
          {isPartial && (
            <div className="relative">
              ...
              <div className="mt-8 bg-themed-card rounded-2xl border border-themed p-8 text-center">
                <div className="w-16 h-16 bg-themed-muted rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-themed-muted" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"/>
                  </svg>
                </div>
                <h3 className="font-display text-xl text-themed font-medium mb-2">
                  {isTeaser ? 'The story continues...' : 'Continue reading'}
                </h3>
                <p className="text-themed-muted text-sm mb-6 max-w-md mx-auto">
                  {accessMessage}
                </p>
                <button
                  onClick={onUnlock}
                  className="bg-stone-800 text-white px-8 py-3.5 rounded-full text-sm font-bold uppercase tracking-wider hover:bg-stone-700 transition-all"
                >
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 text-themed-muted hover:text-themed disabled:opacity-20 transition-all text-sm"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
